...
def main():
    ...
    if choice == "Home":
        ...
        webrtc_streamer(key="loopback", video_processor_factory=VideoTransformer)
        ...
        html_temp4 = """
                             		...
                             		<h4 style="color:white;text-align:center;">This Application is developed by Sammed Majalekar.
